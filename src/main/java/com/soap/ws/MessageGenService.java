 ...
 * 2021-03-25T23:28:46.608-07:00
 * Generated source version: 3.3.0
 *
 */
@WebServiceClient(name = "messageGenService",
                  wsdlLocation = "http://localhost:8080/SOAPTest/greetingservice?wsdl",
                  targetNamespace = "http://ws.soap.com/")
public class MessageGenService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://ws.soap.com/", "messageGenService");
    public final static QName MessageGenImplPort = new QName("http://ws.soap.com/", "MessageGenImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/SOAPTest/greetingservice?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MessageGenService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/SOAPTest/greetingservice?wsdl");
        }
        WSDL_LOCATION = url;
    }
