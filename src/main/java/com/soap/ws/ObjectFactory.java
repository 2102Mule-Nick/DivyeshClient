 ...
 * generated in the com.soap.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetMessage_QNAME = new QName("http://ws.soap.com/", "getMessage");
    private final static QName _GetMessageResponse_QNAME = new QName("http://ws.soap.com/", "getMessageResponse");
    private final static QName _GetTotal_QNAME = new QName("http://ws.soap.com/", "getTotal");
    private final static QName _GetTotalResponse_QNAME = new QName("http://ws.soap.com/", "getTotalResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.soap.ws
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://ws.soap.com/", name = "getMessage")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.soap.com/", name = "getMessageResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.soap.com/", name = "getTotal")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.soap.com/", name = "getTotalResponse")
